package br.com.rango.ngc.util.jsf;
 ...
 */
public abstract class AbstractBean<Entity, Business extends RangoHbNgc<Entity>>
{
      ...
      try
      {
    	  if(validarAcesso(Variaveis.ACAO_PREPARA_ALTERAR))
    	  {
    		...
    		//	  setEntity(getSelectedRowEntity());
    			  ...
    			  // searchObject);
    			  // }
    		  	  JSFUtil.copiarPropriedades(entityAlt, entity);
...
//   }
   ...
   protected boolean validarAcesso(String acao) 
   {
	...
	public Entity getEntityAlt() {
		return entityAlt;
	}
	
	public void setEntityAlt(Entity entityAlt) {
