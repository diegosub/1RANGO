...
{
	document.getElementById('formHeader:contadorSessao').innerHTML= formataSegundos(tempoMaximoSessao / 1000 - tempoPassado);
	...
	{
		document.getElementById('formHeader:lblExpira').innerHTML = "Sessão expirada";
		document.getElementById('formHeader:contadorSessao').innerHTML = "";
		return false;
	}
